...
<html>
    ...
    <body>
        ...
        <div id="myBtnContainer">
            ...
            <a href="login.jsp"><button class="login" onclick="filterSelection('login')"> Login</button></a>
            <a href="register.jsp"><button class="register" onclick="filterSelection('register')"> Register</button></a>
        </div>
